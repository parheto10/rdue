...
from .models import Campagne, CampagneProjet, CategorieEspece, Certification, Cooperative, Countrie, Culture, \
    ...
    Detail_Age_Femme, Detail_phyto, Detail_Engrais, Acte_Propriete, SectionPoint, Point, Fournisseur
...
class RecolteProducteurAdmin(ImportExportModelAdmin):
    list_display = ["code", "parcelle", "campagne", "estimation_production", "poids_total", "gap",  "check_gap"]
    list_filter = ["parcelle__producteur__section__cooperative", "check_gap"]
