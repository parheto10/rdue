...
urlpatterns = [
    ...
    path('productions-list/',views.ProductionList.as_view()), #ProductionList
    path('pse-list/',views.PseList.as_view()), #PseList
    ...
    path('export-parcelle-cooperative/',views.export_production_cooperative),
    # path('generate_pdf_with_qrcode-cooperative/',views.generate_pdf_with_qrcode),
    path('generate_pdf_with_qrcode-cooperative/',views.export_production_cooperative),
